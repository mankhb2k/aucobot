...
export const authAlertClassName =
  "mb-4 rounded-md border border-danger bg-danger-dim p-3 text-sm text-danger [&_a]:font-semibold [&_a]:text-danger";
...
export const authGhostButtonClassName =
  "cursor-pointer border-0 bg-transparent p-2 text-sm font-medium text-primary transition-colors hover:text-primary-hover disabled:cursor-not-allowed disabled:opacity-60";
